...
- (void)BtnDialCall;
{
    if(![[cVaxSIPUserAgentEx GetOBJ] VaxDialCall:[self.phoneNumber stringByReplacingOccurrencesOfString:@"+" withString:@""]])
    {
...
- (IBAction)dismissViewController:(id)sender
{
    ...
    [Utils savaRecentContacts:startCallDate endDate:endCallDate phone:self.phoneNumber];
    self.phoneNumberLbl.text = self.phoneNumber;
}
